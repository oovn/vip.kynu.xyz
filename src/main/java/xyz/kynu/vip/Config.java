...
public final class Config {
	...
	public static final String LOGTAG = "vip.kynu.xyz";

	public static final Jid BUG_REPORTS = Jid.of("vip@kynu.xyz");

	public static final String DOMAIN_LOCK = "yax.im"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "yax.im";
	...
	public static final boolean SHOW_CONNECTED_ACCOUNTS = true;
	...
	public static final int PING_MAX_INTERVAL = 240;
	public static final int IDLE_PING_INTERVAL = 540; //540 is minimum according to docs;
	...
	public static final int MESSAGE_MERGE_WINDOW = 0;
