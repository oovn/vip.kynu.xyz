...
import xyz.kynu.vip.databinding.ActivityShowLocationBinding;
import xyz.kynu.vip.ui.util.LocationHelper;
import xyz.kynu.vip.ui.util.UriHelper;
import xyz.kynu.vip.ui.widget.Marker;
import xyz.kynu.vip.ui.widget.MyLocation;
...
public class ShowLocationActivity extends LocationActivity implements LocationListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			switch (action) {
				case "xyz.kynu.vip.location.show":
